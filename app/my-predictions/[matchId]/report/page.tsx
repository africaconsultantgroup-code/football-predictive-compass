...
async function resolve(userId:string,matchId:string):Promise<{report:PostMatchReport|null;pending:boolean}>{try{return {report:await loadPostMatchReport(userId,matchId),pending:false}}catch(e){if(e instanceof ReportAccessError&&e.code==="not_final")return {report:null,pending:true};throw e}}
